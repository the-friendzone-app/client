    ...
    render() {
        return (
            <form
                ...
                />
                <label htmlFor="username">Username <span className="tooltip"> <i className="fa fa-info-circle" aria-hidden="true"></i><span class="tooltiptext">Your username will be kept private. We will provide you a Friend Zone Username to use inside The Friend Zone!</span></span></label>
                <Field
                    component={Input}
                    type="text"
                    name="username"
